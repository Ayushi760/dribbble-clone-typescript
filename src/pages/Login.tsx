...
import wixIcon from "../assets/images/wixicon.svg";
    ...
    <div className="flex w-screen h-screen">
      ...
      <div className="relative flex items-center w-full h-full shadow-md max-laptop_sm:justify-center">
        <div className="ml-[100px] px-[60px] pt-[30px] w-full max-w-[536px] max-laptop_sm:ml-0">
          <h2 className="mb-10 text-2xl font-bold" style={{ fontFamily: "Mona-Sans" }}>
            Sign in to Dribbble
          </h2>
          ...
          <form onSubmit={handleLogin}>
            ...
            <button className="w-full bg-[#0c0c21] rounded-[100px] font-semibold text-white mt-5 h-14" type="submit">
              Sign in
            </button>
          </form>
