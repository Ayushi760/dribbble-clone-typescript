  ...
  return (
    <div className="py-[120px] bg-[#ffda79] text-center w-full">
      <div className="flex flex-col items-center justify-center gap-6 px-8">
        <h2 className="max-w-[620px] mx-auto text-[64px] leading-[72px] font-normal" style={{ fontFamily: "source-serif-4" }}>
          Find your next designer today
        </h2>
        <p className="max-w-[580px] mx-auto text-xl leading-[36px] text-[#0d0c22]" style={{ fontFamily: "Mona-Sans" }}>
        ...
        <div className="flex justify-center w-full gap-4 pt-4 pb-6" style={{ fontFamily: "Mona-Sans" }}>
          <a
        ...
        <div className="max-w-[400px] mx-auto text-xl text-[#0d0c22] leading-[36px]" style={{ fontFamily: "Mona-Sans" }}>
          Are you a designer?{" "}
